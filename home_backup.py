...
import sys
BASE = Path(__file__).resolve().parent          # .../05_Projeto/exemplo_california
ROOT = BASE.parent                              # .../05_Projeto
...
st.title("Previsão de preços de imoveis")
...
with coluna1:
    ...
    with st.form(key='formulario'):
        ...
        housing_median_age = st.number_input('Idade do imével', value=10, min_value=1, max_value=50)
